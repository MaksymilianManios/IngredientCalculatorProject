 ...
 * @author makma
 */
public class NewRecipePanel extends javax.swing.JFrame {
    ...
    public NewRecipePanel(Recipe recipe) {   
        initComponents();
        this.recipe = recipe;       
        initList();
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int ret = JOptionPane.showConfirmDialog(this,ingredientPanel,"New Ingredient",JOptionPane.OK_CANCEL_OPTION);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        int ret = JOptionPane.showConfirmDialog(this, ingredientPanel,"Edit Ingredient",JOptionPane.OK_CANCEL_OPTION);        
        if(ret == JOptionPane.OK_OPTION){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewRecipePanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewRecipePanel().setVisible(true);
            }
        });
    }
